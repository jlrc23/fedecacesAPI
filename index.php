...
$app->get('/api/v1/account/new', '\App\Controllers\CreateAccount\CreateAccountController:index');
$app->post('/api/v1/account/new', '\App\Controllers\CreateAccount\CreateAccountController:index');
